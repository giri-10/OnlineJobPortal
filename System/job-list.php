		...
		<header id="header">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/pngegg.png" alt="Logo" style="height: 60px; width: 60px;" /></a>
						</div>
					</div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About CareerHub</h5>
											<p>CareerHub is a job portal, online job management system</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">CareerHub Jobs Contact</h5>
								
								<p>Address : Bangalore</p>
								<p>Email : <a href="mailto:careerhub@gmail.com">careerhub.2@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">+91 8415467474</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> CareerHub</p>
