...
<head>
<meta charset="utf-8">
<title>Career Hub - <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+91) 9986554678</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Career Hub<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          24, JP Nagar 3rd Phase, <br>
          Bengaluru-56003</address>
          <p>
            <i class="icon-phone"></i> (+91) 8574921038 <br>
            <i class="icon-envelope-alt"></i> info@careerhub.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; CareerHub 2024 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
